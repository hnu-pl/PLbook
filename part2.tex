...
큰걸음 관계($\Longmapsto$)의 왼항이 환경과 식의 순서쌍인
...
\vspace*{-2em}
\[
\frac{~~}{~ \langle\sigma,x\rangle \stackrel{\!\!_\textrm{cbv}}{\Longmapsto} \sigma(x) ~}
\qquad\qquad
\frac{~~}{~ \sigma,\lambda x.e \stackrel{\!\!_\textrm{cbv}}{\Longmapsto} \langle\sigma,\lambda x.e\rangle ~}
\]
\[
\frac{~ \langle\sigma,e_1\rangle \stackrel{\!\!_\textrm{cbv}}{\Longmapsto} \langle\sigma_1,\lambda x.e\rangle
...
\\
\texttt{Env} \,~=~&
	\texttt{Nm} \xrightarrow{~\text{\scriptsize fin}~} \texttt{Expr} &
\sigma\in\texttt{Env} ~::=~& \{\,x_1{\mapsto}e_1,\,\ldots,\,x_k{\mapsto}e_k\,\}
\\[1.5ex]
...
\vspace*{-3ex}
\[
\frac{~ \sigma(x) \stackrel{\!\!_\textrm{cbn}}{\Longmapsto} e
	\quad
	e \stackrel{\!\!_\textrm{cbn}}{\Longmapsto} v
   ~}{~ \langle\sigma,x\rangle \stackrel{\!\!_\textrm{cbn}}{\Longmapsto} v ~}
\qquad
\frac{~~}{~ \langle\sigma,\lambda x.e\rangle \stackrel{\!\!_\textrm{cbn}}{\Longmapsto} \langle\sigma,\lambda x.e\rangle ~}
\]
\[
\frac{~ \langle\sigma,e_1\rangle \stackrel{\!\!_\textrm{cbn}}{\Longmapsto} \langle\sigma_1,\lambda x.e\rangle
~\quad~ \langle\{x{\mapsto}\langle\sigma,e_2\rangle\}\sigma_1,e\rangle \stackrel{\!\!_\textrm{cbn}}{\Longmapsto} v
   ~}{~ \langle\sigma,e_1\,e_2\rangle \stackrel{\!\!_\textrm{cbn}}{\Longmapsto} v ~}
\]
\caption{타입없는 람다계산법의 적용 먼저 값계산(call-by-name evaluation)을
	규정하는 큰걸음 의미구조
	\label{fig:bigStepCVN} }
\end{figure}
