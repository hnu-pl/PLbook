...
%%%%%%%% BEGIN: Jupyter generated LaTeX header %%%%%%%%
    ...
    % for paper printing darker link color
    \definecolor{linkcolor}{rgb}{.11,0.11,0.11}
...
\newcommand{\seeonly}[2]{\ #1}
\renewcommand{\see}[2]{#1, #2}
\makeindex
\usepackage[columns=2, font=footnotesize, indentunit=1em]{idxlayout}
