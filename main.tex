...
정리할 필요가 있다. 이에 대해서는 곧 이어지는 다음 절에서 좀더 이야기하기로 하자.
...
불러도 $L$의 정의는 젼혀 달라질 것이 없다. (더 나아가서,
\txtbullet과 \txtcircle 대신에 $a$와 $b$ 등으로 서로 구분되는
다른 어떤 두 기호를 사용하더라도 탐구하려는 형식언어의 본질이 달라지지는 않는다.)
...
\begin{enumerate}
    ...
    왼쪽 끝의 흑돌 하나로부터 오른쪽으로 하나씩 이어붙여 나가기
    \item
    \fbox{\!\txtbullet\,\fbox{\!\txtcircle\,\fbox{\!\txtbullet\,\fbox{\!\txtcircle\!}}}}
    오른쪽 끝의 백돌 하나로부터 왼쪽으로 하나씩 이어붙여 나가기
    \item
...
\end{subfigure}
\caption{같은 언어에 대한 서로 다른 문법 $G_1$, $G_2$의 정의에 
         따른 문자열의 유도(derivation) 및
...
\begin{align*}
\textbf{문법구조(syntax)} & &\quad& &\textbf{의미구조(semantics)} & \\
a \in \Sigma \qquad & &\quad&
...
& \llbracket\,a\,\rrbracket =\;& \{a\} \\
       \mid\;& r_1\texttt{|}\,r_2 &\quad&
& \llbracket r_1\texttt{|}\,r_2 \rrbracket =\;&
     \llbracket r_1 \rrbracket \cup \llbracket r_2 \rrbracket \\
       \mid\;& r_1\,r_2 &\quad&
& \llbracket\,r_1r_2\,\rrbracket =\;&
