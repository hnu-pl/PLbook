...
\fvset{listparameters=\setlength{\topsep}{0ex}\setlength{\partopsep}{0ex}}
...
functional programming language)로 게으른 계산법(lazy evaluation)에
...
1980년대 후반 즈음에는 게으른 계산법에 따라 실행되는 정적 타입을 갖춘
...
있으며 적극적 계산법(eager evaluation)에 따라 실행되는 함수형 언어인
...
그 이후 적극적 계산법과는 다른 계산 전략(evaluation strategy)인
게으른 계산법(lazy evaluation)에 따르는 학계의 표준적
