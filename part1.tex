...
\index{구체적문범나무|see{concrete syntax tree}}
\index{concrete syntax tree|see{구체적문범나무}}
...
구체적문범나무(concrete syntax tree) 등으로 부른다.
...
구체적문범나무(concrete syntax tree)를 구성하고,
그 핵심만을 요약한
...
\index{구체적문범나무}%
\index{concrete syntax tree}%
구체적문범나무(그림\;\ref{sfig:CST})를 구성하고 이를 요약한
\index{추상문법나무}%
